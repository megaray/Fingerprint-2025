...
void test_compare_fingerprints(const std::string &name_1,
...
int main(int argc, char *argv[])
{
    ...
    std::cout << "The provided tests are not complete. You have to write your own tests."
              << std::endl;
...
void test_get_neighbours_1()
{
    ...
    print_assertion_result(neighbours == expected,
                           vector_to_string(expected),
                           vector_to_string(neighbours));
}
...
void test_connected_pixels_1()
{
    ...
    BinaryImage expected({{false, false, false, true},
                          {false, false, true, true},
                          {false, true, true, false},
                          {false, false, false, false}});
    ...
    print_assertion_result(connected == expected,
                           vector_to_string(expected),
                           vector_to_string(connected));
}
...
void test_connected_pixels_2()
{
    ...
    BinaryImage expected({{false, false, false, false},
...
void test_connected_pixels_3()
{
    ...
    BinaryImage image({{true, false, false, true, true},
                       {true, false, true, true, false},
                       {true, true, false, false, false},
                       {false, true, false, true, false}});

    BinaryImage expected({{true, false, false, true, false},
                          {true, false, true, true, false},
                          {true, true, false, false, false},
...
void test_compute_slope_horizontal()
{
    ...
    BinaryImage connected({{false, false, false}, {false, true, true}, {false, false, false}});
...
void test_extract_single_minutia()
{
    ...
    BinaryImage skeleton({{false, false, false}, {false, true, true}, {false, false, false}});
...
void test_apply_rotation()
{
    ...
    print_assertion_result(result == expected,
                           minutia_to_string(expected),
                           minutia_to_string(result));
...
void test_thin()
{
    ...
    print_file_comparison_result(skeleton == expected_skeleton,
                                 expected_thin_filename,
                                 actual_thin_filename);
...
void test_draw_minutiae(const std::string &name)
{
    ...
    std::cout << "Visual test: open the file minutiae_" + name
                     + ".png and check that the minutiae (red circles) are placed correctly"
              << std::endl;
    std::cout << "The image should be identical to the one in the resources/test_outputs/minutiae_"
                     + name + ".png file"
              << std::endl;
}
...
void test_with_skeleton()
{
    ...
    bool passes(minutiae.size() == expected.size()
                               ...
                               bool expected_result)
{
    ...
    print_assertion_result(is_match == expected_result,
                           std::to_string(expected_result),
                           std::to_string(is_match));
}
